...
public class Orc extends Monster{
	private static final int monster_hp = 45;
	private static final int attackDamage = 15;
	public Orc(String monster_id, int posx,int posy) {
		super("Orc", monster_id, monster_hp);
		this.monster_height = 200 ;
		this.monster_width = 150 ;
		this.monster_xpos=posx;
		this.monster_ypos=posy;
		this.moster_image = new Image(ClassLoader.getSystemResource("monsterImage/Orc.png").toString());
