...
public class Dragon extends Monster{
	private static final int monster_hp = 80;
	private static final int attackDamage = 25;
	public Dragon(String monster_id, int posx,int posy) {
		super("Dragon", monster_id, monster_hp);
		this.monster_height = 200 ;
		this.monster_width = 300 ;
		this.monster_xpos=posx;
		this.monster_ypos=posy;
		this.moster_image = new Image(ClassLoader.getSystemResource("monsterImage/Dragon.png").toString());
